...
periods = [
    ("Recent (0-1440min, 0-24h)", 0, 1440),
    ("Recent (0-2880min, 0-48h)", 0, 2880),
    ("Training window (2880-10080min, 2-7 days ago)", 2880, 10080),
    ("Full dataset", 0, max(energy_per_step.keys()))
]
