...
* Use my referal code for Octopus Energy: <https://share.octopus.energy/jolly-eel-176>
* Use my referal code for Axle Energy (UK): <https://vpp.axle.energy/landing/grid?ref=R-VWIICRSA>
