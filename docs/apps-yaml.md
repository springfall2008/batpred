...
For example, if you just want same day last week's consumption:
...
If today is Monday 3:15pm and Predbat is predicting the forward plan for the next 48 hours:
...
Extending the previous example but this time days_previous is set to use history from the previous day:
...
Today is still Monday 3:15pm and Predbat is predicting the forward plan for the next 48 hours:
