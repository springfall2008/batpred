...
when battery_charge_power_curve option is _not_ set in apps.yaml and Predbat is started for the first time (due to restarting AppDaemon or an edit to apps.yaml).
