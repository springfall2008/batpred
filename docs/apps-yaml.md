...
- **db_commit_interval** - Defaults to 0 (immediate commits). This controls how often (in seconds) changes to the database are written to the physical disk. Increasing this (e.g. to 30 or 60) drastically reduces disk I/O and wear on SD cards.
