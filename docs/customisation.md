...
If the current time is inside one of your car's charging slots but the car is not charging, Predbat cancels that slot and every later one, so the battery is no longer held for the car and the plan can include potential export again.
For an Octopus Intelligent dispatch the slot's cheap rate is withdrawn too, as Octopus may bill a dispatch the car does not use at the full rate.
