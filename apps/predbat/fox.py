...
# Fox integration config options
# When enabled, Predbat will not wire Fox PV energy/power entities into the
# standard pv_today/pv_power config arguments.
FOX_PV_IGNORE_CONFIG_KEY = "fox_pv_ignore"
...
class FoxAPI(ComponentBase, OAuthMixin):
    ...
    async def automatic_config(self):
        ...
        fox_pv_ignore = self.base.get_arg(FOX_PV_IGNORE_CONFIG_KEY, default=False)
        if not fox_pv_ignore:
