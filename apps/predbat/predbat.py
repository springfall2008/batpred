...
class PredBat(hass.Hass):
    ...
    def rate_min_forward_calc(self, rates):
        ...
        self.log("Rate min forward looking: now {}, and at end of forecast {}".format(self.dp2(rate_min_forward[self.minutes_now]), self.dp2(rate_min_forward[self.forecast_minutes])))
