...
CONFIG_ITEMS = [
    ...
    {"name": "inverter_loss", "friendly_name": "Inverter Loss", "type": "input_number", "min": 0, "max": 1.0, "step": 0.01, "unit": "fraction", "icon": "mdi:call-split", "default":04},
    ...
    {"name": "best_soc_margin", "friendly_name": "Best SOC Margin", "type": "input_number", "min": 0, "max": 30.0, "step": 0.10, "unit": "kwh", "icon": "mdi:battery-50", "default":0.0},
    ...
    {"name": "best_soc_step", "friendly_name": "Best SOC Step", "type": "input_number", "min": 0.1, "max": 1.0, "step": 0.05, "unit": "kwh", "icon": "mdi:battery-50", "default":0.25},
    {
    ...
    {"name": "combine_mixed_rates", "friendly_name": "Combined Mixed Rates", "type": "switch", False},
    ...
    {"name": "set_reserve_enable", "friendly_name": "Set Reserve Enable", "type": "switch", "default":False},
    {"name": "set_reserve_hold", "friendly_name": "Set Reserve Hold", "type": "switch", "default":False},
    ...
    {"name": "config_grouping", "friendly_name": "PredBat Config Group", "type": "select", "options": list(CONFIG_GROUPS.keys()), "icon": "mdi:list-box-outline", "default":list(CONFIG_GROUPS.keys()[0]},
