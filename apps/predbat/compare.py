...
class Compare:
    ...
    def fetch_rates(self, tariff, rate_import_base, rate_export_base):
        ...
        if "rates_import_octopus_url" in tariff:
            ...
            pb.rate_import = pb.download_octopus_rates(pb.resolve_arg("rates_import_octopus_url", tariff["rates_import_octopus_url"]))
        ...
        if "rates_export_octopus_url" in tariff:
            ...
            pb.rate_export = pb.download_octopus_rates(pb.resolve_arg("rates_export_octopus_url", tariff["rates_export_octopus_url"]))
