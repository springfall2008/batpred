...
class OctopusAPI:
    ...
    async def fetch_tariffs(self, tariffs):
        ...
        for tariff in tariffs:
            ...
            self.base.dashboard_item(entity_id, rate_now, attributes={"friendly_name": "Octopus Tariff " + tariff, "icon": "mdi:currency-gbp", "rates": self.base.filtered_times(rates_stamp), "product_code": product_code, "tariff_code": tariff_code}, app="octopus")
