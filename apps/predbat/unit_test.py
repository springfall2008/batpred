...
def run_execute_test(my_predbat, name, charge_window_best=[], charge_limit_best=[], discharge_window_best=[], discharge_limits_best=[], soc_kw=0, read_only=False, set_soc_enable=True, set_charge_window=False, set_discharge_window=False, assert_charge_time_enable=False, assert_force_discharge=False,
...
def run_execute_tests(my_predbat):    
    ...
    failed |= run_execute_test(my_predbat, "charge2", charge_window_best=charge_window_best, charge_limit_best=charge_limit_best2, assert_charge_time_enable=True, set_charge_window=True, assert_status="Hold charging", soc_kw=9, assert_charge_start_time_minutes=-1, assert_charge_end_time_minutes=my_predbat.minutes_now + 60, set_discharge_during_charge=False, assert_discharge_rate=0, assert_pause_discharge=True) 
    failed |= run_execute_test(my_predbat, "charge3", charge_window_best=charge_window_best, charge_limit_best=charge_limit_best2, assert_charge_time_enable=True, set_charge_window=True, assert_status="Charging", soc_kw=9, assert_charge_start_time_minutes=-1, assert_charge_end_time_minutes=my_predbat.minutes_now + 60) 
