...
from tests.test_best_soc_keep_auto_tune import test_best_soc_keep_auto_tune
...
def main():
    ...
    TEST_REGISTRY = [
        ...
        ("best_soc_keep_auto_tune", test_best_soc_keep_auto_tune, "Best SoC Keep auto-tune observer tests", False),
