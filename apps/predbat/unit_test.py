...
def run_inverter_tests():
    ...
    failed |= test_inverter_rest_template(
        ...
        assert_nominal_capacity=9.52,
        assert_battery_temperature=24.8,
    )
    if failed:
        return failed
...
def run_execute_tests(my_predbat):
    ...
    my_predbat.battery_temperature_discharge_curve = {20: 1.0, 10: 0.5, 9: 0.5, 8: 0.5, 7: 0.5, 6: 0.3, 5: 0.3, 4: 0.3, 3: 0.262, 2: 0.1, 1: 0.1, 0: 0}
