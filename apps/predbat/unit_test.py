...
from tests.test_web_soc_drift_chart import test_soc_drift_chart
...
def main():
    ...
    TEST_REGISTRY = [
        ...
        ("web_soc_drift_chart", test_soc_drift_chart, "SoCPlanDrift chart (predict_soc_best fan chart over debug-history snapshots) tests", False),
