...
class ActiveTestInverter:
    ...
    def adjust_charge_window(self, charge_start_time, charge_end_time, minutes_now):
        ...
        print("Adjust charge window {} {} {}".format(charge_start_time, charge_end_time, minutes_now))
...
def run_execute_tests(my_predbat):    
    ...
    failed |= run_execute_test(my_predbat, "no_charge2", set_charge_window=True, set_discharge_window=True)
    failed |= run_execute_test(my_predbat, "no_chargefuture", set_charge_window=True, set_discharge_window=True, charge_window_best=charge_window_best4, charge_limit_best=charge_limit_best)
