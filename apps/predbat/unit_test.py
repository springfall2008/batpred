...
from tests.test_car_charging_now_confirmed_slots import test_car_charging_now_confirmed_slots, test_car_charging_now_confirmed_slots_midnight_rollover, test_car_charging_now_confirmed_slots_dst_rollover
...
def main():
    ...
    TEST_REGISTRY = [
        ...
        ("car_charging_now_confirmed_slots_dst_rollover", test_car_charging_now_confirmed_slots_dst_rollover, "Car charging now confirmed-slots midnight rebase survives a spring DST transition", False),
