...
"""
    ...
    def get_chart(self, chart):
        ...
        if not soc_kw_best:
            ...
            inday_adjust_hist = history_attribute(self.base.get_history_wrapper(self.base.prefix + ".load_inday_adjustment", 2, required=False), scale=0.01)
            ...
            pv_power_hist = history_attribute(self.base.get_history_wrapper(self.base.prefix + ".pv_power", 7, required=False))
            pv_power = prune_today(pv_power_hist, self.now_utc, self.midnight_utc, prune=chart == "PV")
            pv_forecast_hist = history_attribute(self.base.get_history_wrapper("sensor." + self.base.prefix + "_pv_forecast_h0", 7, required=False))
            pv_forecast_histCL = history_attribute(self.base.get_history_wrapper("sensor." + self.base.prefix + "_pv_forecast_h0", 7, required=False), attributes=True, state_key="nowCL")
