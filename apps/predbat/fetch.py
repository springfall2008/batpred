...
class Fetch:
    ...
    def fetch_config_options(self):
        ...
        load_ml_source_mode = self.get_arg("load_ml_enable", False) and self.get_arg("load_ml_source", False)
        if load_ml_source_mode and self.calculate_inday_adjustment:
