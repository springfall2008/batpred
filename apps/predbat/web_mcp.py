...
class MCPServerWrapper:
    ...
    async def _execute_get_plan(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "error": None,
                "data": self.base.raw_plan,
                "timestamp": datetime.now().isoformat(),
                "description": "Current Predbat battery plan including forecasts, costs, and operational states"
            }
            
        except Exception as e:
            return {
                "success": False,
                "error": f"Error retrieving plan data: {str(e)}",
                "data": None
            }
    ...
    async def _execute_get_entities(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "error": None,
                "data": returned_entities,
                "timestamp": datetime.now().isoformat(),
                "description": "The current Predbat entities and their states"
            }
            
        except Exception as e:
            return {
                "success": False,
                "error": f"Error retrieving entities data: {str(e)}",
                "data": None
            }
    ...
    async def _execute_set_plan_override(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if not override_time:
                return {
                    "success": False,
                    "error": "Invalid time format. Use 'Day HH:MM' format e.g. Sat 14:30",
                    "data": None
                }
            ...
            if minutes_from_now >= 17 * 60:
                return {
                    "success": False,
                    "error": "Override time must be within 17 hours from now.",
                    "data": None
                }
            ...
            return {
                "success": False,
                "error": f"Error applying plan override: {str(e)}",
                "data": None
            }
    ...
    async def _execute_get_config(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "data": config_return,
                "timestamp": datetime.now().isoformat(),
                "description": "The contents of the Predbat configuration settings"
            }
            
        except Exception as e:
            return {
                "success": False,
                "error": f"Error retrieving apps.yaml data: {str(e)}",
                "data": None
            }
    ...
    async def _execute_get_apps(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Error retrieving Predbat apps.yaml data: {str(e)}",
                "data": None
            }
    ...
    async def _execute_set_config(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if not entity_id or value is None:
                return {
                    "success": False,
                    "error": "Both 'entity_id' and 'value' must be provided",
                    "data": None
                }
            ...
            return {
                ...
                "timestamp": datetime.now().isoformat(),
                "description": f"Configuration setting '{entity_id}' updated successfully"
            }
        ...
        try:
            if request.method == "POST":
                ...
                return {
                    ...
                    "error": {
                        "code": -32600,
                        "message": f"Invalid Request: {request.method} not supported, use POST"
                    }
                }
    ...
    async def _handle_tools_list(self, params):
        ...
        return {
            'tools': [
                {
                    'name': 'get_plan',
                    'description': 'Get the current Predbat battery plan data including forecast, costs, and state information',
                    'inputSchema': {
                        'type': 'object',
                        'properties': {},
                        'required': []
                ...
                {
                    'name': 'get_status',
                    'description': 'Get the current Predbat system status and configuration',
                    'inputSchema': {
                        'type': 'object',
                        'properties': {},
                        'required': []
                ...
                },
                {
                    ...
                    'inputSchema': {
                        ...
                        'properties': {
                            'filter': {
                                'type': 'string',
                                'description': 'The configuration item name to filter on, as a Python regex (optional)'
                            }
                        },
                        'required': []
                    }
                },
                {
                    ...
                    'inputSchema': {
                        ...
                        'properties': {
                            'filter': {
                                'type': 'string',
                                'description': 'The entity ID name to filter on, as a Python regex (optional)'
                            }
                        },
                        'required': []
                    }
                ...
                },
                {
                    ...
                    'inputSchema': {
                        ...
                        'properties': {
                            'entity_id': {
                            'type': 'string',
                            'description': 'The entity ID of the configuration setting to update'
                            },
                            'value': {
                            'type': 'string',
                ...
                },
                {
                    ...
                    'inputSchema': {
                        ...
                        'properties': {
                            'action': {
                            'type': 'string',
                            'description': 'The action to perform: demand, charge, export, freeze_charge, freeze_export, clear'
                            },
                            'time': {
                            'type': 'string',
                            'description': 'The time at which to perform the action, in "Day HH:MM" format (24-hour), covers one 30-minute period'
                            }
                        },
    ...
    class MockBase:
        ...
        def __init__(self):
            self.raw_plan = {
                "test": "data",
                "forecast": [
                    {"time": "10:00", "soc": 50, "cost": 0.15},
                    {"time": "11:00", "soc": 60, "cost": 0.12}
                ],
                "totals": {"cost_today": 5.50, "profit_today": 2.30}
            }
            self.soc_kw = 50
            self.soc_max = 100
            self.reserve = 10
