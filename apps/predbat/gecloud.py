...
class GECloudDirect:
    ...
    async def publish_registers(self, device, registers):
        """
        ...
        for key in registers:
            ...
            print("Register {} value {} validation_rules {} validation {}".format(reg_name, value, validation_rules, validation))
            ...
            for validation_rule in validation_rules:
                ...
                if validation_rule.startswith("between:"):
                    ...
                    attributes["state_class"] = "measurement"
                    if "%" in reg_name:
                        attributes["device_class"] = NumberDeviceClass.BATTERY
                        attributes["unit_of_measurement"] = "%"
                    elif "_power_percent" in ha_name:
                        attributes["device_class"] = NumberDeviceClass.POWER_FACTOR
                        attributes["unit_of_measurement"] = "%"
                    elif "_power" in ha_name:
                        attributes["device_class"] = NumberDeviceClass.POWER
            ...
            if is_select_date or is_select_options:
                ...
                self.base.set_state_wrapper(entity_name + "_" + ha_name, state=value, attributes=attributes)
            if is_number:
    ...
    async def start(self):
        ...
        self.log("GECloud: Found devices {}".format(self.devices))
