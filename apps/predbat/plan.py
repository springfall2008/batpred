                ...
                for window_n_target in range(record_export_windows - 1, 0, -1):
                    ...
                    if export_limit_target < 100:
                        ...
                        if best_metric_drop <= selected_metric:
                            if self.debug_enable:
                                self.log("Drop export window {} limit {} {}-{} metric {} cost {} keep {} cycle {} carbon {} import {}".format(window_n_target, export_limit_target, self.time_abs_str(self.export_window_best[window_n_target]["start"]), self.time_abs_str(self.export_window_best[window_n_target]["end"]), best_metric_drop, dp2(best_cost_drop), dp2(best_keep_drop), dp2(best_cycle_drop), dp0(best_carbon_drop), dp2(best_import_drop)))
