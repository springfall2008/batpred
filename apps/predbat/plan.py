...
class Plan:
    ...
    def calculate_plan(self, recompute=True, debug_mode=False, publish=True):
        ...
        if self.get_arg("arbitrage_enable", False) and self.soc_max > 0:
            try:
                ...
                _soc_kw = self.soc_kw
                _soc_percent = (_soc_kw / _soc_max * 100.0)
                ...
                self.log("Warn: ArbitrageEngine failed, skipping arbitrage: {}".format(err))
