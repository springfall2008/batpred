...
class OhmeAPI:
    ...
    async def publish_data(self):
        ...
        self.log(
            "Info: Ohme API: Mode: %s, Status: %s, Power: %sW, %sA, %sV, CT: %sA, Max Charge: %s, Available: %s, Target SOC: %s%%, Target Time: %s, Preconditioning: %s mins, Vehicle: %s, Slots: %s"
            % (mode, status, power.watts, power.amps, power.volts, power.ct_amps, max_charge, available, target_soc, target_time, preconditioning, vehicle, slots)
        )
