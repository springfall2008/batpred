...
APPS_SCHEMA = {
    ...
    "futurerate_sensor_import": {"type": "sensor", "sensor_type": "float|integer|string"},
    "futurerate_sensor_export": {"type": "sensor", "sensor_type": "float|integer|string"},
    "futurerate_sensor_attribute": {"type": "string", "empty": False},
    "futurerate_sensor_time_key": {"type": "string", "empty": False},
    "futurerate_sensor_rate_key": {"type": "string", "empty": False},
