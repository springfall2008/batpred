...
CONFIG_ITEMS = [
    ...
    {
        "name": "best_soc_keep_auto_tune",
        "friendly_name": "Best SoC Keep Auto Tune (suggest only, not applied)",
        "type": "switch",
        "default": False,
        "enable": "expert_mode",
    },
    {
        "name": "best_soc_keep_auto_tune_alpha",
        "friendly_name": "Best SoC Keep Auto Tune Alpha",
        "type": "input_number",
        "min": 0.01,
        "max": 1.0,
        "step": 0.01,
