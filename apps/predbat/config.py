...
CONFIG_ITEMS = [
    ...
    },
    {
        ...
        "type": "select",
        "options": ["pv_estimate", "pv_estimate10", "pv_estimate90", "pv_estimateCL", "clearsky", "historical"],
...
APPS_SCHEMA = {
    ...
    "clipping_buffer_forecast": {"type": "string", "allowed": ["pv_estimate", "pv_estimate10", "pv_estimate90", "pv_estimateCL", "clearsky", "historical"]},
