...
CONFIG_ITEMS = [
    ...
    {
        "name": "clipping_buffer_start_offset",
        "friendly_name": "Clipping Buffer Start Offset",
        "type": "input_number",
        "min": 0,
        "max": 120,
        "step": 5,
    ...
    {
        "name": "clipping_buffer_end_offset",
        "friendly_name": "Clipping Buffer End Offset",
        "type": "input_number",
        "min": 0,
        "max": 120,
        "step": 5,
...
APPS_SCHEMA = {
    ...
    "clipping_buffer_start_offset": {"type": "integer"},
    "clipping_buffer_end_offset": {"type": "integer"},
