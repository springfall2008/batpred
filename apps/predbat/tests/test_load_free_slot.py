...
def test_load_free_slot(my_predbat):
    ...
    midnight_slot = [
        {
            "start": "2025-01-15T23:00:00+00:00",
            "end": "2025-01-16T01:00:00+00:00",
            "rate": 0.0
        }
    ]
    ...
    future_slot = [
        {
            "start": "2025-01-17T10:00:00+00:00",  # Day 3, outside forecast
            "end": "2025-01-17T11:00:00+00:00",
            "rate": 0.0
        }
    ]
    ...
    partial_slot = [
        {
            "start": "2025-01-16T23:00:00+00:00",  # Near end of day 2
            "end": "2025-01-17T02:00:00+00:00",    # Extends into day 3 (beyond forecast)
            "rate": 0.0
        }
    ]
    ...
    bonus_slot = [
        {
            "start": "2025-01-15T10:00:00+00:00",
            "end": "2025-01-15T11:00:00+00:00",
            "rate": -5.0  # Negative rate (you get paid to use electricity)
        }
    ]
    ...
    overlap_slot = [
        {
            "start": "2025-01-15T10:00:00+00:00",
            "end": "2025-01-15T11:00:00+00:00",
            "rate": 5.0  # Higher than existing 1.0 for first 30 mins
        }
    ]
