...
def test_fetch_octopus_rates(my_predbat):
    ...
    test_rates = [
        {
            ...
            "valid_to": "2025-01-01T00:30:00+00:00"
        },
        {
            "value_inc_vat": 16.2,
            "valid_from": "2025-01-01T00:30:00+00:00",
            "valid_to": "2025-01-01T01:00:00+00:00"
        },
        {
            "value_inc_vat": 14.8,
            "valid_from": "2025-01-01T01:00:00+00:00",
            "valid_to": "2025-01-01T01:30:00+00:00"
        },
    ]
    
    # Set up mock sensor state
    my_predbat.ha_interface.dummy_items["event.octopus_energy_electricity_abc123_current_day_rates"] = {
        "state": "on",
        "rates": test_rates
    }
    ...
    previous_rates = [
        {
            "value_inc_vat": 10.0,
            "valid_from": "2024-12-31T23:00:00+00:00",
            "valid_to": "2024-12-31T23:30:00+00:00"
        },
        {
            "value_inc_vat": 10.5,
            "valid_from": "2024-12-31T23:30:00+00:00",
    ...
    next_rates = [
        {
            "value_inc_vat": 20.0,
            "valid_from": "2025-01-02T00:00:00+00:00",
            "valid_to": "2025-01-02T00:30:00+00:00"
        },
    ]
    
    # Set up mock event sensors
    my_predbat.ha_interface.dummy_items["event.octopus_energy_electricity_abc123_previous_day_rates"] = {
        "state": "on",
        "rates": previous_rates
    }
    
    my_predbat.ha_interface.dummy_items["event.octopus_energy_electricity_abc123_next_day_rates"] = {
        "state": "on",
        "rates": next_rates
    }
    ...
    my_predbat.ha_interface.dummy_items["sensor.nordpool_test"] = {
        ...
        "raw_today": [
            {
                "price": 0.155,  # Price in EUR/kWh, will be scaled by 100
                "from": "2025-01-01T00:00:00+00:00",
                "till": "2025-01-01T01:00:00+00:00"
            },
        ]
    }
    ...
    my_predbat.ha_interface.dummy_items["sensor.nordpool_test"]["raw_tomorrow"] = [
        {
            ...
            "till": "2025-01-02T01:00:00+00:00"
        },
    ]
        ...
        "rates": [
            {
                ...
                "valid_from": "2025-01-01T00:00:00+00:00",
                "valid_to": "2025-01-01T00:30:00+00:00",
                "is_intelligent_adjusted": True  # This slot should be marked as adjusted
            },
            {
                "value_inc_vat": 15.5,
                "valid_from": "2025-01-01T00:30:00+00:00",
    ...
    my_predbat.ha_interface.dummy_items["sensor.no_attributes"] = {
        "state": "15.5"
    }
