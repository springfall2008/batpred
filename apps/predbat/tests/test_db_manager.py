...
def _test_db_manager_set_get_state(my_predbat=None):
    ...
    async def run_test():
        ...
        try:
            ...
            print("PASS: DatabaseManager started successfully")
            ...
            print(f"PASS: set_state_db returned correct structure: {result}")
            ...
            print(f"PASS: get_state_db retrieved correct state and attributes: {retrieved}")
            ...
            print(f"PASS: Timezone conversion verified: GMT+2 10:00 -> GMT+0 {parsed_ts.strftime('%H:%M:%S')}")
            ...
            print(f"PASS: State update works correctly: {retrieved3['state']}")
            ...
            print(f"PASS: Cleaned up temp directory: {mock_base.config_root}")
...
def _test_db_manager_entities_and_history(my_predbat=None):
    ...
    async def run_test():
        ...
        try:
            ...
            print(f"PASS: get_all_entities_db returned correct entities: {all_entities}")
            ...
            print(f"PASS: get_history_db returned {len(history_data)} history entries")
            ...
            print(f"PASS: Found {found_count} of {len(historical_states)} expected historical states")
            ...
            for entry in history_data[:3]:
                ...
                if timestamp_str:
                    ...
                    try:
                        ...
                        print(f"PASS: Timestamp format correct: {timestamp_str}")
                        break
...
def _test_db_manager_error_handling(my_predbat=None):
    ...
    async def run_test():
        ...
        try:
            ...
            print(f"PASS: get_state_db correctly returned None for non-existent entity")
            ...
            print(f"PASS: get_history_db correctly returned empty for non-existent entity")
            ...
            print(f"PASS: IPC queue still functional after error handling")
            ...
            print(f"PASS: get_all_entities_db returned valid list: {len(all_entities)} entities")
...
def _test_db_manager_persistence(my_predbat=None):
    ...
    async def run_test():
        ...
        try:
            ...
            print("PASS: DatabaseManager started successfully (first instance)")
            ...
            print(f"PASS: Stored {len(all_entities)} entities: {all_entities}")
            ...
            await task1
            print("PASS: DatabaseManager stopped and thread exited (first instance)")
            ...
            print("PASS: DatabaseManager restarted successfully (second instance)")
            ...
            print(f"PASS: All {len(all_entities_after)} entities persisted after restart")
            ...
            for entity_id, expected_state, expected_attributes in test_data:
                ...
                print(f"PASS: Entity {entity_id}: state={retrieved['state']}, attributes preserved")
            ...
            await task2
            print("PASS: DatabaseManager stopped and thread exited (second instance)")
...
def _test_db_manager_commit_throttling(my_predbat=None):
    ...
    async def run_test():
        ...
        try:
            ...
            print(f"PASS: First commit happened at {first_commit_time}")
            ...
            print(f"PASS: Rapid writes within 5 seconds did not trigger new commits (last_commit_time unchanged)")
            ...
            print(f"PASS: After pushing time back 6s, new commit triggered at {third_commit_time}")
            ...
            print("PASS: All data persisted correctly despite commit throttling")
