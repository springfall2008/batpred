...
from carbon import CarbonAPI, TIME_FORMAT_CARBON
import asyncio
import requests
...
MOCK_CARBON_API_RESPONSE = {
    "data": {
        ...
        "data": [
            {
                "from": "2025-12-20T14:00Z",
                "to": "2025-12-20T14:30Z",
                "intensity": {"forecast": 265, "index": "very high"}
            },
            {
                "from": "2025-12-20T14:30Z",
                "to": "2025-12-20T15:00Z",
                "intensity": {"forecast": 232, "index": "high"}
            },
            {
                "from": "2025-12-20T15:00Z",
                "to": "2025-12-20T15:30Z",
                "intensity": {"forecast": 292, "index": "very high"}
            }
        ]
    }
}

MOCK_CARBON_API_RESPONSE_EMPTY = {
    "data": {
        "regionid": 11,
        "dnoregion": "WPD South West",
        "shortname": "South West England",
...
def test_time_format_conversion(my_predbat=None):
    ...
    mock_response_data = {
        "data": {
            ...
            "data": [
                {
                    "from": "2025-12-20T14:00Z",  # TIME_FORMAT_CARBON
                    "to": "2025-12-20T14:30Z",
                    "intensity": {"forecast": 265}
                }
            ]
        }
    }
...
def test_json_data_collection(my_predbat=None):
    ...
    response2 = {
        "data": {
            ...
            "postcode": "BS16",
            "data": [
                {"from": "2025-12-22T14:00Z", "to": "2025-12-22T14:30Z", "intensity": {"forecast": 300}}
            ]
        }
    }
