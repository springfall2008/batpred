...
async def test_octopus_events(my_predbat):
    ...
    expected_commands = [
        {"command": "set_intelligent_target_time", "value": "05:30"},
        {"command": "set_intelligent_target_percentage", "value": 90},
    ...
    api.commands = [
        {"command": "set_intelligent_target_percentage", "value": 90},
        {"command": "set_intelligent_target_time", "value": "07:30"},
        {"command": "join_saving_session_event", "event_code": "EVENT-2024-002"}
    ]
    ...
    api.commands = [
        {"command": "unknown_command", "value": "test"},
        {"command": "set_intelligent_target_percentage", "value": 75}
    ]
