...
def test_get_github_directory_listing_success(my_predbat):
    ...
    mock_response = [
        ...
        {
            "name": "tests",
            "path": "apps/predbat/tests",
            "type": "dir"  # Should be filtered out
        }
    ]
        ...
        manifest = [
            {
                ...
                "sha": compute_file_sha1(test_file1)
            },
            {
                "name": "test2.py",
                "size": os.path.getsize(test_file2),
                "sha": compute_file_sha1(test_file2)
            }
        ]
        ...
        manifest = [
            {
                ...
                "sha": compute_file_sha1(test_file)
            }
        ]
