...
class PredHeat:
    ...
    def get_weather_data(self, now_utc):
        ...
        result = self.call_service_websocket("weather/get_forecasts", type="hourly", entity_id=entity_id, response_variable="service_result", return_response=True)
        self.log("Predheat: Weather data {}".format(result))

        data = self.get_arg("weather", attribute="forecast", domain="predheat")
        self.temperatures = {}
